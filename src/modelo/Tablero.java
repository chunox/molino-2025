...
public class Tablero {
    ...
    public boolean colocarPieza(String id, Jugador jugador) {
        ...
        pos.ocupar(jugador);
        jugador.piezaColocada();
        return true;
    }

    public boolean moverPieza(String origen, String destino, Jugador jugador, boolean puedeVolar) {
    ...
    public boolean eliminarPieza(String id, Jugador jugador) {
        Posicion pos = posiciones.get(id);
        ...
        pos.liberar();
        jugador.piezaEliminada();
        return true;
    }

    public boolean formaMolino(String posicion, Jugador jugador) {
    ...
    public List<String> getPosicionesOcupadasPor(Jugador jugador) {
